_Secret Suitors_ was a prototype built for Pod People, a podcasting company based in Los Angeles, California. They wanted to leverage their audio experience for a casual game, and contracted Something Mighty to do so. The premise of the game is that the player has come in the possession of a mysterious answering machine that allows them to hear voice messages from suitors in the past.
...
I encouraged Pod People to optimize their UI design for a phone layout, since I anticipated that most casual players would want to play the game on their phone or tablet. I then leveraged web technology to ensure the same experience on PC, Android, and iPhone.
...
[2]: SS_Calendar.png '{ "orientation": "right" }'
